...
- Тайлы и права: как `tiles` отдаёт только разрешённые к просмотру типы (параметр с правами или JWT в запросе тайла).
- Мульти-геометрии нужны сразу или достаточно базовых (point/linestring/polygon)?
